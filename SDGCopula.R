...
.packages = c('mvtnorm', 'copula', 'fitdistrplus', 'plotrix', 'psych', 'ggcorrplot', 'gridExtra', 'reshape2', 'ggplot2')
...
RMSE <- function(orig, syn) return(sqrt(sum((tonumeric(df)-tonumeric(simulated))^2)))
